...
class AccountTest {
    ...
    void writeSingleTransaction_onSuccess_changeState() {
        ...
        SingleTransaction transaction = new SingleTransaction(account, OCCUR, MONEY_ONE, DESCRIPTION);
    ...
    void readSingleTransactionsDuringParams_onSuccess_returnsFilteredList() {
        ...
        SingleTransaction t1 = new SingleTransaction(account, OCCUR, MONEY_ONE, DESCRIPTION);
        LocalDateTime begin = LocalDateTime.now();
        SingleTransaction t2 = new SingleTransaction(account, OCCUR, MONEY_ONE, DESCRIPTION);
        LocalDateTime end = LocalDateTime.now();
        SingleTransaction t3 = new SingleTransaction(account, OCCUR, MONEY_ONE, DESCRIPTION);
